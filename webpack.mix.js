...
mix.js('resources/js/index.js', 'public/js')
    ...
    .js('resources/js/new-card.js', 'public/js')
    .js('resources/js/admin-menu.js', 'public/js')
mix.less('resources/less/index.less', 'public/css')
    ...
    .less('resources/less/new-card.less', 'public/css')
    .less('resources/less/admin-menu.less', 'public/css')
mix.version()
