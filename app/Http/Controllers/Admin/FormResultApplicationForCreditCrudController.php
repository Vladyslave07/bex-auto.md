 ...
 */
class FormResultApplicationForCreditCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setRoute(config('backpack.base.route_prefix') . '/form-result/' . ApplicationForCredit::SLUG_FORM);
