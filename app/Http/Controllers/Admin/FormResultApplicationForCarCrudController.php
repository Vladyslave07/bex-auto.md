 ...
 */
class FormResultApplicationForCarCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setRoute(config('backpack.base.route_prefix') . '/form-result/' . ApplicationForCar::SLUG_FORM);
