...
use App\Http\Livewire\Forms\BuyAndDeliveryAuto;
 ...
 */
class FormResultBuyAndDeliveryAutoCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setRoute(config('backpack.base.route_prefix') . '/form-result/' . BuyAndDeliveryAuto::SLUG_FORM);
    ...
    {
        CRUD::addClause('where', 'slug_form', BuyAndDeliveryAuto::SLUG_FORM);
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::addField([
            'name' => 'car',
            'label' => trans('backpack::fields.car'),
            'type' => 'text',
            'wrapperAttributes' => ['class' => 'form-group col-md-6']
        ]);
        CRUD::addField([
            'name' => 'country',
            'label' => trans('backpack::fields.country'),
            'type' => 'text',
            'wrapperAttributes' => ['class' => 'form-group col-md-6']
        ]);
        CRUD::addField([
