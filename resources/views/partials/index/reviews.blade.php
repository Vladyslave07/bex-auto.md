    ...
    <div class="swiper reviews-swiper">
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <div class="header">
                    <picture>
                        <img class="review-avatar" width="54" height="56" src="{{ $review->user_icon }}" loading="lazy" alt="">
                    </picture>
                    <div>
                        ...
                        <div class="review-rating">
                            ...
                            <time class="review-data" datetime="2021-09-22 14:56">{{ $review->date_created_review }}</time>
                        </div>
                    </div>
                </div>
