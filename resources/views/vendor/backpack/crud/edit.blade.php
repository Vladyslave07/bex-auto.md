		  ...
		  {!! method_field('PUT') !!}
            ...
            @include('crud::inc.form_save_buttons')
              ...
              @if(($entry = $crud->getCurrentEntry()) && in_array($crud->getCurrentEntry()->getTable(), ['cars', 'products']))
                  <a href="{{ route($crud->getCurrentEntry()->detailRouteName, $entry->slug, false) }}" class="btn btn-primary"><span class="la la-arrow-right"></span> &nbsp;{{ trans('backpack::crud.show_page') }}</a>
              @endif
