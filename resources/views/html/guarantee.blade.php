...
<div class="container">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page">Гарантії</li>
        </ol>
    </nav>
</div>
<!-- ///:end/// -->
...
<div class="guarantee">
    <div class="container">
        <h1 class="main-title noline color-red">Гарантії</h1>
        <div class="text-page">
            <h2 class="main-title text-center noline color-blue">Компанія “Bexhill Trading Auto” гарантує надання повної звітності в процесі покупки авто з США.</h2>
            <div class="width-fix">
                <picture>
            ...
            <h2 class="main-title noline color-red">Гарантії на авто з США:</h2>
            <ul>
                <li>
                    Звіт CarFax на кожен автомобіль з США до його придбання. У ньому міститься наступна інформація:
                    <ol>
                        <li>Кількість і якість технічного обслуговування транспортного засобу.</li>
                        <li>Кількість ДТП, якщо такі були в період експлуатації.</li>
                        <li>Кількість власників.</li>
                        <li>Заводські відгуки.</li>
                    </ol>
                </li>
                <li>Звіт про придбання американського авто на аукціоні (скрін з особистого кабінету аукціону)</li>
                <li>Приблизний прорахунок вартості ремонту (за бажанням клієнта)</li>
                <li>Фотозвіт транспортного засобу перед вантаженням в контейнер</li>
                <li>Надаємо номер контейнера, в якому автомобіль транспортується в Україну, що дозволяє відстежувати маршрут і терміни прибуття в порт призначення.</li>
            </ul>
            <br>
            <br>
            <h2 class="main-title noline color-red">Гарантійні зобов’язання компанії:</h2>
            <ul>
                <li>Укладення договору про співпрацю, який регулює взаємовідносини сторін щодо надання послуг підбору, покупки, доставки і розмитнення автомобіля</li>
                <li>Всі оплати проводяться в безготівковій формі на розрахунковий рахунок компанії, реквізити якої вказані в договорі</li>
                <li>Клієнту надається можливість розірвання договору в односторонньому порядку і повернення авансу до покупки автомобіля</li>
                <li>Супровід клієнта на всіх етапах угоди до моменту отримання автомобіля</li>
                <li>Наявність особистого кабінету дозволяє відстежувати фото, етапи доставки і оплати</li>
            </ul>
        </div>
    </div>
</div>
