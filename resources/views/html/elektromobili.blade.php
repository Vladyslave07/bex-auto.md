...
@section('title', 'Електрокари')

@push('styles')
    <link rel="stylesheet" href="{{ mix('css/elektromobili.css') }}">
@endpush

@push('scripts')
    <script src="{{ mix('js/elektromobili.js') }}" defer></script>
@endpush
    ...
    <div class="container">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">Електрокари</li>
            </ol>
        </nav>
        <!-- ///:end/// -->
        <br>
        ...
        <picture class="img">
            <source type="image/webp" srcset="{{ asset('img/example/img_37.webp') }}" media="(max-width: 767px)">
            <source type="image/webp" srcset="{{ asset('img/example/img_37.webp') }}" media="(min-width: 768px)">
            <img width="935" height="551" src="{{ asset('img/example/img_37.png') }}" alt="">
        </picture>
    </div>
</div>
<!-- ///:end/// -->
...
<!-- ///НАЗВАНИЕ РАЗДЕЛА/// -->
<div class="container">
    <h1 class="main-title text-center line-left h1">Електрокари</h1>
</div>
<!-- ///:end/// -->
...
<div class="section-catalog container">
    <div class="tab-links row">
        ...
        <a href="catalog" class="active">Електрокари з США</a>
