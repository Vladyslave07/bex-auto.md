...
<div class="container">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page">Электрические и гибридные автомобили приравняли к опасным грузам</li>
        </ol>
    </nav>
</div>
<!-- ///:end/// -->
...
<div class="article container">
    <h1 class="main-title text-center noline color-blue">Электрические и гибридные автомобили приравняли к опасным грузам</h1>
    <div class="text-page">
        <h3 class="color-red">Международные морские линии повышают ставки на фрахт электромобилей и гибридных транспортных средств</h3>
        <p>Благодаря последним научным разработкам и достижениям в области производства литий-ионных аккумуляторов, современные электромобили практически не уступают по ходовым характеристикам машинам, которые работают на топливе. Это стало причиной повышения спроса на автомобили с электродвигателем и гибридные авто, и соответственно, привело к увеличению их экспорта. В результате большинство судоходных линий приняли решение ужесточить требования, касающиеся отправки аккумуляторных авто, приравнять их к категории опасных грузов, а также повысить ставки на их транспортировку.</p>
        <br>
        <picture>
            <source type="image/webp" srcset="{{ asset('img/example/img_30.webp') }}">
            <img class="height-fix" width="878" height="537" src="{{ asset('img/example/img_30.png.png') }}" alt="">
        </picture>
        <h3 class="color-red">Могут ли автомобили на литиевых батареях представлять опасность?</h3>
        <p>Аккумуляторы действительно могут быть опасны, если они не упакованы надлежащим образом, перезаряжены или повреждены. Наличие дефектов может привести к перегреву, короткому замыканию и даже возгоранию, которое крайне сложно поддается тушению.  При покупке подержанного автомобиля на аукционе невозможно гарантировать целостность упаковки или отсутствие повреждений.</p>
        <br>
        <br>
        <h3 class="color-red">Особенности транспортировки электромобилей и гибридных транспортных средств</h3>
        <p>Все транспортные средства, которые оборудованы литиевыми аккумуляторными батареями (включая гибридные автомобили) должны перевозиться как опасный груз, при отправке которых необходимо соблюдать определенные требования:</p>
        <ul>
            <li>При бронировании места на судне обязательно необходимо заявить груз как опасный.</li>
            <li>После загрузки контейнера опасный груз в обязательном порядке подлежит декларированию. В документации необходимо обозначить класс опасности, уровень токсичности, воспламеняемости и т.д и получить подтверждение верности заполнения декларации от судоходной линии.</li>
        </ul>
        <p>Судоходные линии ввели крупные штрафы для отправителей, которые не выполняют требования в полном объеме:</p>
        <ul>
            <li>Линия Cosco штрафует отправителя за отсутствие декларации или неправильное ее заполнение на 20 000$.</li>
            <li>У линии Hapag штраф составляет 15 000 $</li>
            <li>Maersk придется заплатить 5 000$.</li>
        </ul>
        <p>С сожалением констатируем, что в связи со сложившейся ситуацией мы также вынуждены повышать стоимость доставки гибридов и электромобилей из США.</p>
    </div>
</div>
<!-- ///:end/// -->
