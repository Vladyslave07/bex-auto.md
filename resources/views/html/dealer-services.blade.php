...
<div class="section-countries container">
    ...
    <div class="swiper countries-swiper">
        <div class="swiper-wrapper nav-tabs">
            <div class="swiper-slide item active" data-toggle="tab" data-target="#partnerTab_1">
                <picture>
                    <source type="image/webp" srcset="{{ asset('img/example/img_45.webp') }}">
                    <img width="215" height="144" src="{{ asset('img/example/img_45.png') }}" loading="lazy" alt="">
                </picture>
                Корея
            </div>
            <div class="swiper-slide item" data-toggle="tab" data-target="#partnerTab_2">
                <picture>
                    <source type="image/webp" srcset="{{ asset('img/example/img_46.webp') }}">
                    <img width="215" height="144" src="{{ asset('img/example/img_46.png') }}" loading="lazy" alt="">
                </picture>
                Китай
            </div>
            <div class="swiper-slide item" data-toggle="tab" data-target="#partnerTab_3">
                <picture>
                    <source type="image/webp" srcset="{{ asset('img/example/img_47.webp') }}">
                    <img width="215" height="144" src="{{ asset('img/example/img_47.png') }}" loading="lazy" alt="">
                </picture>
                США
            </div>
            <div class="swiper-slide item" data-toggle="tab" data-target="#partnerTab_4">
                <picture>
                    <source type="image/webp" srcset="{{ asset('img/example/img_48.webp') }}">
                    <img width="215" height="144" src="{{ asset('img/example/img_48.png') }}" loading="lazy" alt="">
                </picture>
                Грузия
            </div>
            <div class="swiper-slide item" data-toggle="tab" data-target="#partnerTab_5">
                <picture>
                    <source type="image/webp" srcset="{{ asset('img/example/img_49.webp') }}">
                    <img width="215" height="144" src="{{ asset('img/example/img_49.png') }}" loading="lazy" alt="">
                </picture>
                Евросоюз
            </div>
        </div>
...
<div class="section-partners">
    <div class="container">
        <div class="tab-content">
            <div id="partnerTab_1" class="tab-pane active">
                <div class="main-title text-center noline">Корея</div>
                <p>
                    1) Широкий выбор площадок для покупки<br>
                    2) Доступ к аукционам ( выдача кнопки)<br>
                    3) Наша лицензия позволяет приобретать автомобили в США, Канаде, Гаваи.<br>
                    4) Бесплатный Carfax ( проверка от страховой базы данных)<br>
                    5 ) Проверка авто сотрудником компании на аукционах IAAI, Copart, Manheim<br>
                    6) Минимальные сборы аукционов для оптовых клиентов.<br>
                    7) Переделка проблемных тайтлов/брифов.<br>
                    8) Сухопутная перевозка до порта отправления<br>
                    9) Морская перевозка до порта в Грузии.<br>
                    11) Предоставление фото из портов при загрузке и выгрузке.<br>
                    12) Организация ремонта авто перед ввозом в Казахстан.<br>
                    13) Поиск и подбор автозапчастей для ремонта.<br>
                </p>
                <div class="auctions">
                    <div class="item">
                        <picture class="img">
            ...
            <div id="partnerTab_2" class="tab-pane">
                <div class="main-title text-center noline">Китай</div>
                <p>
                    1) Широкий выбор площадок для покупки<br>
                    2) Доступ к аукционам ( выдача кнопки)<br>
                    3) Наша лицензия позволяет приобретать автомобили в США, Канаде, Гаваи.<br>
...
<div class="section-team container">
    <div class="main-title text-center">Наши специалисты</div>
    <div class="swiper team-swiper">
        <div class="swiper-wrapper">
            <div class="swiper-slide item">
                <picture>
                    <source type="image/webp" srcset="{{ asset('img/example/img_53.webp') }}">
                    <img width="227" height="265" src="{{ asset('img/example/img_53.png') }}" loading="lazy" alt="">
                </picture>
                <div class="name">Имя Фамилия</div>
                <a href="tel:1231231245">+123 123 12 45</a>
                <a href="mailto:invan@bex.auto">invan@bex.auto</a>
            </div>
            <div class="swiper-slide item">
                <picture>
                    <source type="image/webp" srcset="{{ asset('img/example/img_54.webp') }}">
                    <img width="227" height="265" src="{{ asset('img/example/img_54.png') }}" loading="lazy" alt="">
                </picture>
                <div class="name">Имя Фамилия</div>
                <a href="tel:1231231245">+123 123 12 45</a>
                <a href="mailto:invan@bex.auto">invan@bex.auto</a>
            ...
            <div class="swiper-slide item">
                <picture>
                    <source type="image/webp" srcset="{{ asset('img/example/img_55.webp') }}">
                    <img width="227" height="265" src="{{ asset('img/example/img_55.png') }}" loading="lazy" alt="">
                </picture>
                <div class="name">Имя Фамилия</div>
                <a href="tel:1231231245">+123 123 12 45</a>
                <a href="mailto:invan@bex.auto">invan@bex.auto</a>
