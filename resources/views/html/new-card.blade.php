...
<div class="container">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="catalog">Авто з Кореї</a></li>
    ...
    <div class="bg">
        <div class="container">
            <div class="card-gallery">
                <div class="swiper gallery-swiper">
                    <div class="swiper-wrapper">
                        <a href="https://placehold.jp/2A3D68/ffffff/2000x1000.png" data-fancybox="gallery" class="swiper-slide">
                            <picture>
                                <source type="image/webp" srcset="https://placehold.jp/2A3D68/ffffff/890x590.png">
                                <img width="890" height="590" src="https://placehold.jp/2A3D68/ffffff/890x590.png" alt="">
                            </picture>
                        </a>
                        <a href="https://placehold.jp/2A3D68/ffffff/2000x1000.png" data-fancybox="gallery" class="swiper-slide">
                            <picture>
                ...
                <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <picture>
                                <source type="image/webp" srcset="https://placehold.jp/2A3D68/ffffff/94x94.png">
                                <img width="94" height="94" src="https://placehold.jp/2A3D68/ffffff/94x94.png" alt="">
                            </picture>
                        </div>
                        <div class="swiper-slide">
                            <picture>
            ...
            <div class="card-title">
                <h1 class="main-title">GAC AION LX</h1>
