...
export default function() {
    ...
    if(window.innerWidth > 767) {
        fetch('https://service-reviews-ultimate.elfsight.com/data/reviews?uris%5B%5D=ChIJ65xHpcAxxkARJEBFodPIK-g&with_text_only=1&min_rating=5&page_length=100&order=date', {
            method: 'GET',
            headers: {
